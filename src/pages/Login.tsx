...
export function Login() {
  ...
  async function handleSubmit(e: FormEvent) {
    ...
    // On success the auth listener redirects via <Navigate> above.
  }
    ...
    <div className="flex min-h-screen items-center justify-center bg-navy-700 px-4">
      <div className="w-full max-w-sm">
        <div className="mb-6 text-center">
          ...
          <h1 className="mt-3 text-2xl font-bold text-white">Audit Firm Task Manager</h1>
          <p className="text-sm text-navy-200">Internal work allocation &amp; tracking</p>
        </div>
        ...
        <p className="mt-4 text-center text-xs text-navy-200">
          Your session is remembered on this device.
        </p>
      </div>
    </div>
  );
